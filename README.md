...
EPI-LENS is a [GitHub Pages tool](https://pi-0r-tau.github.io/EPI-LENS/) and  browser extension designed to analyse video content for potentially harmful photosensitive triggers in real-time. (WCAG 2.3.1 Three flashes or below threshold testing) Designed for use in empirical research, accessibility auditing and machine learning dataset generation. 


Extracts temporal, spatial and spectral metrics from video content and exports data as CSV, JSON and NDJSON.

Think of it similar to PEAT (Photosensitive Epilepsy Analysis Tool) but open source, vanilla JS and a browser extension for youtube analysis and a GitHub pages tool for offline video analysis.
